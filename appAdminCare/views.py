...
def ayuda_autonomica(request):
    ...
    communities = [
        ...
        {'slug': 'castilla_la_mancha',   'name': 'Castilla-La Mancha',  'image': 'images/clm.jpg'},
        {'slug': 'castilla_y_leon',      'name': 'Castilla y León',     'image': 'images/cyl.jpg'},
        ...
        {'slug': 'comunidad_de_madrid',  'name': 'Comunidad de Madrid', 'image': 'images/madrid.jpg'},
        {'slug': 'comunidad_valenciana', 'name': 'Comunidad Valenciana','image': 'images/cv.jpg'},
        {'slug': 'extremadura',          'name': 'Extremadura',         'image': 'images/extremadura.jpg'},
        {'slug': 'galicia',              'name': 'Galicia',             'image': 'images/galicia.jpg'},
        {'slug': 'islas_baleares',       'name': 'Islas Baleares',      'image': 'images/baleares.jpg'},
        {'slug': 'la_rioja',             'name': 'La Rioja',            'image': 'images/rioja.jpg'},
        {'slug': 'murcia',               'name': 'Murcia',              'image': 'images/murcia.jpg'},
        {'slug': 'navarra',              'name': 'Navarra',             'image': 'images/navarra.jpg'},
        {'slug': 'pais_vasco',           'name': 'País Vasco',          'image': 'images/pais_vasco.jpg'},
    ]
